run_param_set_econ <- function(model, cc, params, params_uid, vx_chars, rr_pct) {
  ...
  if (T){
    ...
    flows_ipj <- flows_ipj[, !c("age_from", "age_thru")]
    ...
    SES_High_deadT    <- trt_succ[SES == "high" & dim == "TB" & (HIV != "HIVdead") & (TB == "TBdead" | TB == "TBHIVdead")  &
                                    subject =="TBtr_died" & flow == "in",
                                  .(SES_High_dead = sum(value)), by = .(Country = country, Year = year, AgeGrp)]
    
    SES_Low_deadT    <- trt_succ[SES == "low" & dim == "TB" & (HIV != "HIVdead") & (TB == "TBdead" | TB == "TBHIVdead")  &
                                   subject =="TBtr_died" & flow == "in",
    ...
    tb_vxa <- flows_ipj[dim == "VXa" & subject == "VXaXi" & flow == "out" &
                          TB != "Rdead" & TB!= "TBdead" & TB != "TBHIVdead" & HIV != "HIVdead"]
