...
# 1. Plot the incidence and mortality rates over time
# 2. Calculate IRR and MRR at 2035 and 2050
# 3. Plot cumulative tx, cases, deaths averted
# 4. Calculate cumulative tx, cases, deaths averted by 2035 and 2050
...
### Have to start from where the intervention XML starts output from, so need to split
## into M72 ones and BCG ones because they start at different years


# Subset to specific years if want (AFTER calculation above)
...
sum_averted <- sum_averted[!(is.na(Value))]
